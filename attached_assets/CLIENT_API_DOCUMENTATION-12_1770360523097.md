...
Edit a previously sent text message in a WhatsApp group. This uses WhatsApp's native message editing feature, so group members will see the updated message with an "edited" indicator.
...
- WhatsApp enforces an edit time window of approximately 15 minutes after the message was originally sent. After this window closes, edits will fail.
...
- **Message deletion is not currently supported.** Only editing of sent text messages is available.
